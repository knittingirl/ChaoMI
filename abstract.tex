...
The preprint of the paper is available at \url{https://nimgnoeseel.github.io/resources/paper/leak.pdf}. The permanent link to the artifact is \url{https://zenodo.org/records/14754168}.
...
The estimation results for RQ1-3 and RQ4 are already provided in the \texttt{result/}, \texttt{data-LocPrivacy/}, and \texttt{data-epassport/} directories. Use the notebooks in the \texttt{notebook/} directory to analyze the results and generate the figures.
...
The script will generate the results in the \texttt{result/} directory.

\paragraph{Combine the results of HyLeak}

Run the script \texttt{combine-hyleak-result.py} with the following command:
...
The script will generate the results in the \texttt{data-LocPrivacy/} directory.
